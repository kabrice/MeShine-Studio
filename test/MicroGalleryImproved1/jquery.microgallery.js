				...
				if(!$(this).hasClass('disabled')){
					if(mode == 'single'){
                        ...
                        if($testnext.length) {
                            ...
                            //console.log("ICIM", $testnext.length, idxLast, incfactor);
                        }else{
	...
	$.fn.build 				= function($this,o,mode,current,incfactor){
        ...
        //console.log("description", $this.html());
			...
			if(mode=='thumbs'){
                ...
                if(!o.cycle) {console.log('thumbs cycle', o.cycle); $.fn.checkLimits($this,current);}
            }
	};
