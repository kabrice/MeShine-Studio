...
class ProjectsContainer extends Component{
    ...
    renderSummaries(){
       ...
       return _.map(this.props.projects, project => {
           let svgData = this.renderSummaryQuestionText(project.summary.question_text, 270);
           return(
               <div key={project.id}  className="col-lg-3 col-md-4 col-xs-6">
                   <Link to="/summary" className="d-block mb-4 h-100">
                       <svg  className="img-fluid img-thumbnail" style={{"cursor": "pointer"}} width="324px" height="354px" viewBox="0 0 324 354" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                           ...
                           <defs>
                               ...
                               <filter x="-24.4%" y={svgData.fy+"%"} width="148.8%" height={svgData.fh+"%"} filterUnits="objectBoundingBox" id="filter-5">
                               ...
                               <g id="Home-Connexion-Page" transform="translate(-399, -121)">
                                   <g id="Post" transform="translate(401, 121)">
                                       <g id="photo-layer">
                                           ...
                                           <g id="Mask"></g>
                                           <image  id={project.summary.cover_image} filter="url(#filter-3)" mask="url(#mask-2)" x="-3.75582787" y="0" width="329.032258" height="240" xlinkHref={project.summary.cover_image}></image>
                                       </g>
                                       <g id="Question-with-details" transform={"translate("+svgData.t[0]+", "+svgData.t[1]+")"}>
                                           <rect id="Rectangle" fill="url(#linearGradient-4)" style={{"mixBlendMode": "luminosity"}} filter="url(#filter-5)" x="0" y={svgData.y} width="320" height={svgData.h+"px"}></rect>
                                           <g id="Comment-sauver-20-ba" transform={"translate(10, "+svgData.tY+")"}>
                                               <mask id="mask-7" fill="white">
                                                   <use xlinkHref="#path-6"></use>
                                               </mask>
                                               <g id="Mask"></g>
                                               <text id="Comment-des-habitant"  fontFamily="AvenirNext-Heavy, Avenir Next" fontSize="16" fontWeight="100" fill="#FFFFFF" dangerouslySetInnerHTML={{__html: svgData.tspans.join('')}}/>
                                           </g>
                                       </g>
                                   </g>
                               </g>
