    ...
    render(){
        ...
        const styles = reactCSS({
            ...
            return <React.Fragment>
                    ...
                    <tr className="alignment-btn text-editor">
                        <td >
                            <button
                                className='alignment-btn-left btn-secondary'
                                data-value='left'
                ...
                <tr><td className="separator"/><td/></tr>
                <tr>
                ...
                <tr className="me-color text-editor" hidden={this.state.hiddenFills}>
                    <td>
                        <div className="btn-group">
                        <div className="item">
                            <input type="color"
                       ...
                       {/*  Activate it while working with images
                       <div className="item">
                ...
                <tr className="me-color text-editor" hidden={this.state.hiddenBorders}>
                    <td>
                        <div className="btn-group">
                            <div className="item">
                                <input type="color"
