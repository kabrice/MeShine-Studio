...
class SummaryView(APIView):
    ...
    def put(self, request, pk, format=None):
        ...
        svgs2 = [{'animEntry': 3,
                  'svg': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="464" height="825" viewBox="0 0 464 825" xml:space="preserve">\n<desc>Created with Fabric.js 2.4.3</desc>\n<defs>\n</defs>\n<g transform="matrix(1 0 0 1 232 412.5)" >\n<rect style="stroke: None; stroke-width: 1; stroke-dasharray: None; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(128,128,128); fill-rule: nonzero; opacity: 1;" x="-231.5" y="-412" rx="0" ry="0" width="463" height="824" />\n</g>\n</svg>',
                  'isText': False, 'speed': 2.12, 'data': "{'id': 'drawingRect', 'loop': False, 'duration': 1000}",
                  'jsonPath': './assets/data1.json', 'isStatic': False,
                  'object': {'height': 824, 'top': 99.5, 'shadow': None, 'flipX': False, 'type': 'rect', 'width': 463,
                             'scaleX': 1, 'fill': 'gray', 'clipTo': None, 'strokeDashArray': None, 'paintFirst': 'fill',
                             'id': 'drawingRect', 'strokeLineJoin': 'miter', 'strokeWidth': 1, 'fillRule': 'nonzero',
                             'flipY': False, 'originX': 'left', 'visible': True, 'originY': 'top',
                             'transformMatrix': None, 'scaleY': 1, 'globalCompositeOperation': 'source-over',
                             'strokeLineCap': 'butt', 'opacity': 1, 'left': 109.66, 'skewY': 0, 'backgroundColor': '',
                             'angle': 0, 'stroke': None, 'skewX': 0, 'strokeMiterLimit': 4, 'version': '2.4.3', 'rx': 0,
                             'ry': 0}, 'duration': 1, 'id': 'drawingRect',
                  'animation': {'html': 'common', 'js': 'animejs_popup', 'css': 'common'}, 'loop': False, 'zIndex': 4,
                  '_boundingRect': {'left': 109.65999999999997, 'height': 825, 'top': 99.5, 'width': 464}},
                 {'animEntry': 1, 'svg': None, 'isText': False,
                  'data': "{'id': 'img75204205', 'loop': False, 'duration': None, 'speed': 1, 'jsonPath': './assets/data1.json', 'height': '100%', 'width': '100%'}",
                  'isStatic': False,
                  'object': {'height': 841, 'top': 512.5, 'shadow': None, 'filters': [], 'flipX': False,
                             'type': 'image', 'width': 487, 'src': 'http://localhost:8081/assets/Gallery2/img_0.png',
                             'scaleX': 0.98, 'fill': 'rgb(0,0,0)', 'clipTo': None, 'strokeDashArray': None,
                             'paintFirst': 'fill', 'id': 'img75204205', 'strokeLineJoin': 'miter', 'strokeWidth': 0,
                             'fillRule': 'nonzero', 'flipY': False, 'originX': 'center', 'visible': True,
                             'originY': 'center', 'transformMatrix': None, 'scaleY': 0.98, 'cropY': 0,
                             'globalCompositeOperation': 'source-atop', 'strokeLineCap': 'butt', 'opacity': 1,
                             'left': 342.16, 'skewY': 0, 'backgroundColor': '', 'angle': 0, 'stroke': None, 'skewX': 0,
                             'strokeMiterLimit': 4, 'version': '2.4.3', 'crossOrigin': '', 'cropX': 0},
                  'duration': None, 'id': 'img75204205',
                  'animation': {'html': 'common', 'js': 'lottie', 'css': 'common'}, 'zIndex': 1,
                  '_boundingRect': {'left': 103.53000000000003, 'height': 824.1799999999998, 'top': 100.41000000000003,
                                    'width': 477.25999999999993}}, {'animEntry': 2,
                                                                    ...
                                                                    'isText': False, 'speed': None,
                                                                    'data': "{'id': 'shape10200', 'loop': False, 'duration': 1000}",
                                                                    'jsonPath': 'None', 'isStatic': False,
                                                                    'object': {'height': 50, 'top': 544.29,
                                                                               'shadow': None, 'flipX': False,
                                                                               'type': 'polygon', 'width': 44,
                                                                               'scaleX': 12.98, 'fill': '#1973D9',
                                                                               'clipTo': None, 'strokeDashArray': None,
                                                                               'paintFirst': 'fill', 'id': 'shape10200',
                                                                               'strokeLineJoin': 'miter',
                                                                               'strokeWidth': 1, 'fillRule': 'nonzero',
                                                                               'flipY': False, 'originX': 'left',
                                                                               'visible': True, 'originY': 'top',
                                                                               'transformMatrix': None, 'scaleY': 8.02,
                                                                               'globalCompositeOperation': 'source-atop',
                                                                               'strokeLineCap': 'butt', 'opacity': 1,
                                                                               'left': 158.79, 'skewY': 0,
                                                                               'backgroundColor': '', 'angle': 22.85,
                                                                               'stroke': '', 'skewX': 0,
                                                                               'strokeMiterLimit': 4,
                                                                               'version': '2.4.3', 'points': [
                                                                            {'y': 25.00002, 'x': 44.00001},
                                                                            {'y': 50.00002, 'x': -1.00000002e-05},
                                                                            {'y': 1.00000002e-05,
                                                                             'x': -1.00000002e-05}]},
                                                                    'id': 'shape10200', 'animation': {'html': 'common',
                                                                                                      'js': 'animejs_popup',
                                                                                                      'css': 'common'},
                                                                    'loop': False, 'zIndex': 2,
                                                                    '_boundingRect': {'left': -0.04064324995994184,
                                                                                      'height': 603.7398416865287,
                                                                                      'top': 544.29,
                                                                                      'width': 697.0934185498147}},
                 {'animEntry': 3,
                  'svg': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="298.9" height="85.1400000000001" viewBox="0 0 298.9 85.14" xml:space="preserve">\n<desc>Created with Fabric.js 2.4.3</desc>\n<defs>\n</defs>\n<g transform="matrix(6.1 0 0 2.58 149.45 42.57)" >\n<rect style="stroke: None; stroke-width: 1; stroke-dasharray: None; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1;" x="-24" y="-16" rx="0" ry="0" width="48" height="32" />\n</g>\n</svg>',
                  'isText': False, 'data': "{'id': 'rect75786250', 'loop': False, 'duration': 1000}", 'jsonPath': None,
                  'isStatic': False,
                  'object': {'height': 32, 'top': 638, 'shadow': None, 'flipX': False, 'type': 'rect', 'width': 48,
                             'scaleX': 6.1, 'fill': '#ffffff', 'clipTo': None, 'strokeDashArray': None,
                             'paintFirst': 'fill', 'id': 'rect75786250', 'strokeLineJoin': 'miter', 'strokeWidth': 1,
                             'fillRule': 'nonzero', 'flipY': False, 'originX': 'center', 'visible': True,
                             'originY': 'center', 'transformMatrix': None, 'scaleY': 2.58,
                             'globalCompositeOperation': 'source-atop', 'strokeLineCap': 'butt', 'opacity': 1,
                             'left': 252.61, 'skewY': 0, 'backgroundColor': '', 'angle': 0, 'stroke': None, 'skewX': 0,
                             'strokeMiterLimit': 4, 'version': '2.4.3', 'rx': 0, 'ry': 0}, 'id': 'rect75786250',
                  'animation': {'html': 'common', 'js': 'animejs_popup', 'css': 'common'}, 'loop': False, 'zIndex': 3,
                  '_boundingRect': {'left': 103.16000000000003, 'height': 85.1400000000001, 'top': 595.43,
                                    'width': 298.9}}, {'animEntry': 4,
                                                       'svg': '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="284.896484375" height="86.42799999999988" viewBox="0 0 284.9 86.43" xml:space="preserve">\n<desc>Created with Fabric.js 2.4.3</desc>\n<defs>\n</defs>\n<g transform="matrix(1 0 0 1 142.45 43.21)" style="" >\n\t\t<text xml:space="preserve" font-family="Times" font-size="35" font-style="normal" font-weight="bold" style="stroke: None; stroke-width: 1; stroke-dasharray: None; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-141.95" y="-11.94" style="fill: rgb(25,115,217); white-space: pre; ">Ce que pensent les </tspan><tspan x="-141.95" y="33.93" style="fill: rgb(25,115,217); ">Nord-Coréens</tspan></text>\n</g>\n</svg>',
                                                       'isText': True, 'speed': 2.12,
                                                       'data': "{'id': 'text75854665', 'loop': False, 'duration': 1300}",
                                                       'jsonPath': None, 'isStatic': False,
                                                       'object': {'textBackgroundColor': '', 'strokeWidth': 1,
                                                                  'shadow': None, 'styles': {
                                                               '1': {'2': {'fill': '#1973d9'}, '5': {'fill': '#1973d9'},
                                                                     '7': {'fill': '#1973d9'},
                                                                     '11': {'fill': '#1973d9'},
                                                                     '4': {'fill': '#1973d9'}, '1': {'fill': '#1973d9'},
                                                                     '6': {'fill': '#1973d9'}, '8': {'fill': '#1973d9'},
                                                                     '3': {'fill': '#1973d9'}, '9': {'fill': '#1973d9'},
                                                                     '10': {'fill': '#1973d9'},
                                                                     '0': {'fill': '#1973d9'}},
                                                               '0': {'2': {'fill': '#1973d9'}, '5': {'fill': '#1973d9'},
                                                                     '12': {'fill': '#1973d9'},
                                                                     '7': {'fill': '#1973d9'},
                                                                     '11': {'fill': '#1973d9'},
                                                                     '13': {'fill': '#1973d9'},
                                                                     ...
                                                                     '10': {'fill': '#1973d9'},
                                                                     '15': {'fill': '#1973d9'},
                                                                     '0': {'fill': '#1973d9'}}}, 'charSpacing': 0,
                                                                  'height': 85.43, 'strokeDashArray': None,
                                                                  'fontSize': '35', 'scaleX': 1, 'clipTo': None,
                                                                  'paintFirst': 'fill', 'strokeLineJoin': 'miter',
                                                                  'id': 'text75854665', 'linethrough': False,
                                                                  'skewX': 0, 'flipY': False, 'originX': 'center',
                                                                  'visible': True, 'lineHeight': 1.16, 'angle': 0,
                                                                  'skewY': 0, 'fillRule': 'nonzero', 'version': '2.4.3',
                                                                  'fontFamily': 'Times',
                                                                  'text': 'Ce que pensent les \nNord-Coréens',
                                                                  'textAlign': 'left', 'top': 638.65, 'flipX': False,
                                                                  'type': 'i-text', 'width': 283.9, 'fill': 'white',
                                                                  'globalCompositeOperation': 'source-atop',
                                                                  'transformMatrix': None, 'fontWeight': 'bold',
                                                                  'originY': 'center', 'scaleY': 1, 'underline': False,
                                                                  'opacity': 1, 'left': 262.82, 'backgroundColor': '',
                                                                  'strokeLineCap': 'butt', 'stroke': None,
                                                                  'overline': False, 'strokeMiterLimit': 4,
                                                                  'fontStyle': 'normal'}, 'id': 'text75854665',
                                                       'animation': {'html': 'common', 'js': 'dominos_dreams',
                                                                     'css': 'common'}, 'loop': False, 'zIndex': 4,
                                                       '_boundingRect': {'left': 120.3717578125,
                                                                         'height': 86.42799999999988, 'top': 595.436,
                                                                         'width': 284.896484375}}, {'animEntry': 5,
                                                                                                    ...
                                                                                                    'zIndex': 5,
                                                                                                    '_boundingRect': {
                                                                                                        'left': 110.23500000000001,
                                                                                                        'height': 41.61999999999989,
                                                                                                        'top': 557.44,
                                                                                                        'width': 258.90999999999997}},
                 {'animEntry': 6,
                  ...
                  'isText': True, 'speed': 2.12, 'data': "{'id': 'text76149977', 'loop': False, 'duration': 1300}",
                  'jsonPath': False, 'isStatic': False,
                  'object': {'textBackgroundColor': '', 'strokeWidth': 1, 'shadow': None, 'styles': {},
                             'charSpacing': 0, 'height': 22.6, 'strokeDashArray': None, 'fontSize': '20', 'scaleX': 1,
                             'clipTo': None, 'paintFirst': 'fill', 'strokeLineJoin': 'miter', 'id': 'text76149977',
                             'linethrough': False, 'skewX': 0, 'flipY': False, 'originX': 'center', 'visible': True,
                             'lineHeight': 1.16, 'angle': 0, 'skewY': 0, 'fillRule': 'nonzero', 'version': '2.4.3',
                             'fontFamily': 'Times', 'text': 'RENCONTRE TRUMP-KIM', 'textAlign': 'left', 'top': 579,
                             'flipX': False, 'type': 'i-text', 'width': 239.45, 'fill': 'white',
                             'globalCompositeOperation': 'source-atop', 'transformMatrix': None, 'fontWeight': 'normal',
                             'originY': 'center', 'scaleY': 1, 'underline': False, 'opacity': 1, 'left': 240.6,
                             'backgroundColor': '', 'strokeLineCap': 'butt', 'stroke': None, 'overline': False,
                             'strokeMiterLimit': 4, 'fontStyle': 'normal'}, 'id': 'text76149977',
                  'animation': {'html': 'common', 'js': 'dominos_dreams', 'css': 'common'}, 'loop': False, 'zIndex': 6,
                  '_boundingRect': {'left': 120.3734375, 'height': 23.59999999999991, 'top': 567.2,
                                    'width': 240.45312500000003}}];
        if questions:
            qs = None
